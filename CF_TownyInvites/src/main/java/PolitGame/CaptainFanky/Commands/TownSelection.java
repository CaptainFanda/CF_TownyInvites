...
public class TownSelection extends Cooldown implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        if(sender instanceof Player p) {
            ...
            if(town == null) {
                String message = CF_TownyInvites.getMassages().get("not-town");
                ...
                if(isCooldown(p.getUniqueId(), cooldown)) {
                    ...
                    if(resident.isMayor()) {
                        ...
                        String message = prefix + CF_TownyInvites.getMassages().get("townSelection");
                        message = message.replace("%town%", town.getName());
                        Bukkit.broadcastMessage(message);
                    } else {
                        String message = prefix + CF_TownyInvites.getMassages().get("not-mayor");
                        p.sendMessage(message);
                    }
                }
